...
k_d_boxplot <- ggplot(plot_df, aes(x = k_d, y = conductance)) +
  geom_boxplot(color = "blue") +
  labs(x= "Value for Kd", y="Conductance", color="Conductance")+
  theme_minimal()

k_o_boxplot <- ggplot(plot_df, aes(x = k_o, y = conductance)) +
  geom_boxplot(color = "purple") +
  labs(x= "Value for Ko",y="Conductance", color="Conductance")+
  theme_minimal()

v_boxplot <- ggplot(plot_df, aes(x = v, y = conductance)) +
  geom_boxplot(color = "gold") +
  labs(x= "Wind Speed", y="Conductance", color="Conductance")+
  theme_minimal()

height_boxplot <- ggplot(plot_df, aes(x = height, y = conductance)) +
